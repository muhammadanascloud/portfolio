...
const Approach = () => {
  return (
    <section className="w-full py-8">
      {" "}
      {/* Reduced py-10 to py-8 */}
      <h1 className="heading mb-16">
        My <span className="text-purple">approach</span>
      </h1>
      {/* Reduced the gap from my-16 to my-8 to bring the section closer */}
...
const Card = ({
  ...
  return (
    <div
      ...
      className="border border-black/[0.2] group/canvas-card flex items-center justify-center dark:border-white/[0.2] max-w-sm w-full mx-auto p-4 relative lg:h-[35rem] rounded-3xl bg-gradient-to-r from-[#0f172a] via-[#1e293b] to-[#0f172a]"
    >
      {/* Phase Icons */}
