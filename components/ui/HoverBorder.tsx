...
>) {
  ...
  // Memoize the rotateDirection function using useCallback
  const rotateDirection = useCallback(
    ...
    [clockwise] // Add `clockwise` as a dependency to useCallback
  );
  ...
  // Now, useEffect will only trigger if `hovered`, `duration`, or `rotateDirection` change
  useEffect(() => {
    if (!hovered) {
  ...
  }, [hovered, duration, rotateDirection]); // Add rotateDirection to dependencies
